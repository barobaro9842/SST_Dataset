...
def download_data(args):
    ...
    for delta in date_range:
        ...
        for dataset_name in dataset_names :
            ...
            if dataset_name == 'AVHRR_OI_SST/v2.1':
            ...
            elif dataset_name == 'NAVO_K10_SST_GDS2' :
